...
class MainWindow(QWidget):
    ...
    def initUI(self):
        ...
        # 设置高度为6行
        font_metrics = self.system_info.fontMetrics()
        line_height = font_metrics.lineSpacing()
        self.system_info.setFixedHeight(line_height * 6)

        # 将中间布局和系统信息显示区域添加到主布局
    ...
    def initCameras(self):
        ...
        for i in range(device_list.nDeviceNum):
            ...
            # 显示相机信息
            info_str = f"相机{i}: {dev_info.SpecialInfo.stGigEInfo.chModelName}"
