...
class ImageViewer(QWidget):
    ...
    def init_ui(self):
        ...
        self.load_button = QPushButton("载入 JSON 文件")
    ...
    def load_json(self):
        ...
        """
        # 打开文件对话框选择 JSON 文件
        self.json_path, _ = QFileDialog.getOpenFileName(self, "选择 JSON 文件", "", "JSON 文件 (*.json)")
        ...
        resized_annotated_image = resize_image(annotated_image, 320, 240)
